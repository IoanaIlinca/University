...
INSERT INTO Members(Mid, Name, Age, Ocupation)
VALUES (4, 'Mateiu Mara', 31, 'influencer');
...
INSERT INTO Projects(Pid, ProjectCoordinator, Name, Timeframe)
VALUES (3, 1, 'Be my Valentine', '14 February 2020');

SELECT * FROM Projects

INSERT INTO MembersInProjects(Mid, Pid)
VALUES (3, 1);
...
SELECT * FROM MembersInProjects

Select Distinct Location from Meetings